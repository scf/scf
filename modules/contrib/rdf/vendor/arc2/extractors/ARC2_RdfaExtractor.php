...
version:  2008-04-09 (Tweak: xhtml namespace is added to tags in XMLLiterals
                      Tweak: s/instanceof/typeof/)
*/
...
class ARC2_RdfaExtractor extends ARC2_RDFExtractor {
  ...
  function getCurrentObjectLiteral($n, $lct, $ct) {
    ...
    elseif (!isset($n['a']['datatype']) || ($dt == 'http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral')) {
      //$xml_val = preg_replace('/<([a-z0-9]+)/i', '<\\1 xmlns="http://www.w3.org/1999/xhtml"', $xml_val);
      $xml_val = preg_replace('/<([a-z0-9]+)/i', '<\\1 xmlns=\'http://www.w3.org/1999/xhtml\'', $xml_val);
      $r['val'] = $xml_val;
