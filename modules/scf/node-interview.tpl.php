...
<?php if ($teaser): ?>
      <?php // @todo Fake the image until Tom has it in place ?>
      <?php print $node->content['byline']['#value']; ?>
      <img src="<?php print base_path() . path_to_theme() ?>/images/dummy-100x100.png" />
      <?php print node_teaser($node->content['body']['#value'], NULL, 240); ?>
<?php else: ?>
      <?php print $node->content['byline']['#value']; ?>
      <div class="interview-abstract"><?php print $node->content['body']['#value']; ?></div>
      <div class="interview-participants"><?php print $node->content['participants']['#value']; ?></div>
			<div class="interview-interviewers"><?php print $node->content['interviewers']['#value']; ?></div>
      <div class="interview-statements"><?php print $node->content['statements']['#value']; ?></div>
<?php endif; ?>
    </div>
